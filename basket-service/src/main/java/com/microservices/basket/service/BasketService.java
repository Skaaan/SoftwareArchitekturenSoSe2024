...
public class BasketService {
    ...
    public Basket addItemToBasket(String userId, String isbn, int quantity) {
        Basket basket = basketRepository.findByUserId(DEFAULT_USER_ID).orElseGet(this::createBasket);
    ...
    public Basket removeItemFromBasket(String userId, String isbn) {
        Basket basket = basketRepository.findByUserId(DEFAULT_USER_ID).orElseThrow(() -> new RuntimeException("Basket not found"));
    ...
    private Basket createBasket() {
        ...
        basket.setUserId(DEFAULT_USER_ID);
        basket.setItems(new ArrayList<>());
        return basket;
    }

    public void clearBasket() {
        basketRepository.findByUserId(DEFAULT_USER_ID).ifPresent(basket -> {
