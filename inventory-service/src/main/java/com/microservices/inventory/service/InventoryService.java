...
public class InventoryService {
    ...
    @Value("${rabbitmq.queue.stock-check-response}")
    private String stockCheckResponseRoutingKey;
    ...
    public void receiveStockCheckRequest(String isbn) {
        ...
        rabbitTemplate.convertAndSend(exchangeName, stockCheckResponseRoutingKey, response);
    }
